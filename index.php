...
<head>
    ...
    <title>Study Tips Website</title>
...
// Aida test
  ...
  <section class="section main-banner" id="top" data-section="section1">
    <video autoplay muted loop id="bg-video">
        <source src="assets/images/studyvideo.mp4" type="video/mp4" />
    </video>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-12">
              <div class="caption">
            <h6>Study Better</h6>
            <h2>Welcome to Study Tips Website</h2>
            <p>Improve your study experience with these tips.</p><br>
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        <div class="owl-courses-item owl-carousel">
          <div class="item">
            <img src="assets/images/logo_1.png" alt="Course One">
          ...
          <div class="item">
            <img src="assets/images/logo_2.png" alt="Course Two">
            <div class="down-content">
